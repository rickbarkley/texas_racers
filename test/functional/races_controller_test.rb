...
class RacesControllerTest < ActionController::TestCase
  ...
  test "should create race" do
    assert_difference('Race.count') do
      post :create, race: { city: @race.city, date: @race.date, description: @race.description, distance: @race.distance, location: @race.location, race_name: @race.race_name, website: @race.website }
    end
  ...
  test "should update race" do
    put :update, id: @race, race: { city: @race.city, date: @race.date, description: @race.description, distance: @race.distance, location: @race.location, race_name: @race.race_name, website: @race.website }
    assert_redirected_to race_path(assigns(:race))
  end
