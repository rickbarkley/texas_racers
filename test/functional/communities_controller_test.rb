...
class CommunitiesControllerTest < ActionController::TestCase
  ...
  test "should create community" do
    assert_difference('Community.count') do
      post :create, community: { contact: @community.contact, description: @community.description, name: @community.name }
    end
  ...
  test "should update community" do
    put :update, id: @community, community: { contact: @community.contact, description: @community.description, name: @community.name }
    assert_redirected_to community_path(assigns(:community))
  end
